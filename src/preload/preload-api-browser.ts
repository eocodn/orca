import { ipcRenderer } from './preload-api-runtime-context';import type { BrowserViewportOverride } from './preload-api-runtime-context';export function createPreloadApiBrowser(): Record<string, unknown> {
  return {
  browser: {
    registerGuest: (args: {
