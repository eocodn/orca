...
import type { LocalLogTailChangedPayload, LocalLogTailReadArgs, LocalLogTailReadResult, LocalLogTailWatchArgs, SshMutationExpectation, DirEntry, FsChangedPayload, MarkdownDocument, SearchOptions, SearchResult } from './preload-api-contract-types';export type PreloadApiBrowser = {
  fs: {
