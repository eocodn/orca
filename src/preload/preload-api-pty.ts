import { ipcRenderer, readRendererHeapStatistics } from './preload-api-runtime-context';import type { ProjectExecutionRuntimeResolution, StartupCommandDelivery, AgentProviderSessionMetadata, SleepingAgentLaunchConfig, TuiAgent, PtyModelRestoreNeededEvent, PtyListedSession, PtyRendererDeliveryHealthReply, PtyRendererDeliveryStateReport, TerminalViewAttributes, PtyMainDeliveryDiagnostics, TerminalSideEffectBatch, AgentKind, LaunchSource, RequestKind, CrashReportBreadcrumbData, CrashReportCopyDiagnosticsArgs, CrashReportSubmitArgs, CrashReportSubmitResult, ReactErrorBoundaryReportArgs, ReactErrorBoundaryReportResult, RendererHeapStatistics } from './preload-api-runtime-context';export function createPreloadApiPty(): Record<string, unknown> {
  return {
  pty: {
    spawn: (opts: {
      cols: number
