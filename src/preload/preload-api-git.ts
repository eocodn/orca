import { ipcRenderer } from './preload-api-runtime-context';import type { GitPushTarget, GitStagingArea, GitForkSyncExpectedUpstream, GitForkSyncResult, GitUpstreamStatus, GitHistoryOptions, GitHistoryResult } from './preload-api-runtime-context';export function createPreloadApiGit(): Record<string, unknown> {
  return {
  git: {
    status: (args: {
      worktreePath: string
