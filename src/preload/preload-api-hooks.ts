import { ipcRenderer, ORCA_UPDATER_QUIT_AND_INSTALL_ABORTED_EVENT, ORCA_UPDATER_QUIT_AND_INSTALL_STARTED_EVENT, prepareRendererForAppRestart, updaterQuitAbortRelay } from './preload-api-runtime-context';import type { SshMutationExpectation, FsChangedPayload, SearchResult, UpdateStatus, RemoteWorkspaceChangedEvent, PreloadApi, ExecutionHostId, LocalLogTailChangedPayload, LocalLogTailReadArgs, LocalLogTailReadResult, LocalLogTailWatchArgs } from './preload-api-runtime-context';export function createPreloadApiHooks(): Record<string, unknown> {
  return {
  hooks: {
    check: (args: {
      repoId: string
