import { ipcRenderer, notificationSoundState, clearNotificationSoundPlaybackState, disposeCachedNotificationSound } from './preload-api-runtime-context';import type { DashboardSnapshot, DashboardRevealAgentArgs, TerminalPreviewConnectResult, TerminalPreviewDataPayload, AgentHookInstallStatus, CustomPet, NotificationDismissResult, NotificationDispatchResult, NotificationDeliveryProbeResult, NotificationPermissionStatusResult, NotificationSoundDataResult, NotificationSoundPathResult, NotificationSoundResult, OnboardingState, ShellOpenExternalEditorRequest, ShellOpenExternalEditorResult, ShellOpenLocalPathResult, SkillDiscoveryResult, SkillDiscoveryTarget, SkillFreshnessInventory, SkillUpdateRun, SkillUpdateStartResult, PreflightRuntimeContext, RefreshAgentsResult } from './preload-api-runtime-context';export function createPreloadApiAgentHooks(): Record<string, unknown> {
  return {
  agentHooks: {
