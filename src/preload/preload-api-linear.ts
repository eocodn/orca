import { ipcRenderer } from './preload-api-runtime-context';import type { CliInstallStatus, CodexConfigSyncStatus, JiraProjectStatusOrder, GhosttyImportPreview, LinearProjectDetail, WarpThemeImportPreview, WarpThemeImportSource, TelemetryConsentState, PreloadApi, KeybindingActionId, KeybindingFileSnapshot, LocalhostWorktreeLabelResult, LocalhostWorktreeLabelRoute } from './preload-api-runtime-context';export function createPreloadApiLinear(): Record<string, unknown> {
  return {
  linear: {
    connect: (args: {
      apiKey: string
