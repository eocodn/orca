...
export const workItemDetailsCacheListeners = new Set<() => void>()
...
export function notifyWorkItemDetailsCache(): void {
...
export let workItemMutatedUnsub: (() => void) | undefined
export let workItemDetailsCacheEventUnsub: (() => void) | undefined
