...
import type { LinearLabel, LinearMember } from '../../../shared/types'
import type { MetadataState } from '@/hooks/issue-metadata-state'

type Setter<T> = React.Dispatch<React.SetStateAction<T>>
export type TaskPageLinearProjectFormContext = {
  newLinearProjectSubmitting: boolean
  newLinearProjectName: string
  setNewLinearProjectName: Setter<string>
  newLinearProjectDescription: string
  setNewLinearProjectDescription: Setter<string>
  newLinearProjectPriority: number
  setNewLinearProjectPriority: Setter<number>
  newLinearProjectMembers: MetadataState<LinearMember[]>
  newLinearProjectLeadId: string | null
  setNewLinearProjectLeadId: Setter<string | null>
  newLinearProjectMemberIds: string[]
  setNewLinearProjectMemberIds: Setter<string[]>
  newLinearProjectLabels: MetadataState<LinearLabel[]>
  newLinearProjectLabelIds: string[]
  setNewLinearProjectLabelIds: Setter<string[]>
  newLinearProjectStartDate: string
  setNewLinearProjectStartDate: Setter<string>
  newLinearProjectTargetDate: string
  setNewLinearProjectTargetDate: Setter<string>
  newLinearProjectContent: string
  setNewLinearProjectContent: Setter<string>
  submitShortcutLabel: string
}

export function TaskPageLinearProjectForm({
  context
}: {
  context: TaskPageLinearProjectFormContext
}): React.JSX.Element {
  const {
