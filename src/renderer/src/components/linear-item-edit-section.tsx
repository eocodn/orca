...
} from './linear-item-edit-model'
import LinearIssueEditPropertiesLayout from './linear-item-edit-properties-layout'
import LinearIssueEditChipsLayout from './linear-item-edit-chips-layout'
...
export function LinearIssueEditSection({
  ...
  if (layout === 'properties') {
    return <LinearIssueEditPropertiesLayout context={editContext} />
  }
  return <LinearIssueEditChipsLayout context={editContext} />
}
export { formatLinearEstimateLabel }
