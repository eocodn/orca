// Concrete surface implementation for IpynbViewer.tsx
// Notebook state remains in this facade; cell rendering owns only presentation and Monaco cell lifecycle.
