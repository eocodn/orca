...
import { Check, ChevronDown, FolderKanban, LoaderCircle, UserRound } from 'lucide-react'
import { LinearPriorityIcon } from '@/components/linear-priority-icon'
import { Popover, PopoverContent, PopoverTrigger } from '@/components/ui/popover'
import { translate } from '@/i18n/i18n'
import type { TaskPageLinearIssueFormContext } from './task-page-linear-issue-form'
import { TaskPageLinearIssueLabelSelector } from './task-page-linear-issue-label-selector'

export function TaskPageLinearIssueAttributes({
  context
}: {
  context: Pick<
    TaskPageLinearIssueFormContext,
  ...
  return (
    <div className="flex flex-wrap items-center gap-2 border-t border-border/40 pt-4 mt-2">
      ...
      <TaskPageLinearIssueLabelSelector
        newLinearIssueSubmitting={newLinearIssueSubmitting}
        newLinearLabels={newLinearLabels}
        newLinearIssueLabelIds={newLinearIssueLabelIds}
        setNewLinearIssueLabelIds={setNewLinearIssueLabelIds}
      />
    </div>
  )
}
