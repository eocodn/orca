...
import { CheckButton, SortIndicator, WorkspaceRow } from './workspace-space-manager-rows'
...
import type { WorkspaceSpaceManagerViewProps } from './workspace-space-manager-view-props'

export function WorkspaceSpaceManagerTable(
  props: WorkspaceSpaceManagerViewProps
): React.JSX.Element {
  const {
    analysis,
    scanError,
