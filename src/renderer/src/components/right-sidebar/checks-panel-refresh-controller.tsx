/* Refresh orchestration for the checks panel. */
...
export function useChecksPanelRefresh<T extends Record<string, unknown>>(context: ChecksPanelRefreshContext<T>): () => Promise<void> {
  const {
    activeConnectionId,
    activeGitLabReview,
    activeWorktreeId,
