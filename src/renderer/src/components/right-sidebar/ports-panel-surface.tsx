// Concrete surface implementation for PortsPanel.tsx; per-entry actions stay together to keep data flow straightforward.
    ...
    async (e: React.FormEvent) => {
      ...
      try {
        await (mode === 'edit' && editId
          ? getClientRuntime().ssh.updatePortForward({
              id: editId,
              targetId,
              localPort: lPort,
          ...
          : getClientRuntime().ssh.addPortForward({
              targetId,
              localPort: lPort,
              remoteHost: remoteHost || 'localhost',
              remotePort: rPort,
