...
import { useChecksPanelGenerationBranchChange } from './checks-panel-generation-branch-change'
export function useChecksPanelGeneration<T extends Record<string, unknown>>(
  context: T & { [K in ChecksPanelGenerationKey]: K extends keyof T ? T[K] : never }
  ...
  const handleBranchChangedByPullRequestGeneration = useChecksPanelGenerationBranchChange({
    fetchUpstreamStatus,
    updatePullRequestGenerationRecord
  })
