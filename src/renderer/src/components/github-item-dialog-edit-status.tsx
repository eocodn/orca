...
import { Ban, ChevronDown, ChevronLeft, ChevronRight, CircleDashed, CircleDot, Copy, Search } from 'lucide-react'
...
type GitHubItemEditStatusProps = {
  ...
  handleStatusPopoverOpenChange: (nextOpen: boolean) => void
  setDuplicatePickerOpen: (open: boolean) => void
  setDuplicateSearch: (search: string) => void
  setDuplicateError: (error: string | null) => void
...
export function GitHubItemEditStatusPopover({
  variant,
  item,
  localState,
  isPending,
  ...
  closeAsDuplicate,
  handleStateChange
}: GitHubItemEditStatusProps): React.JSX.Element {
