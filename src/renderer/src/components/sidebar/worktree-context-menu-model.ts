...
export const DELETE_POSITION_RESTORE_MAX_FRAMES = 180
export const DELETE_POSITION_RESTORE_STABLE_FRAMES = 6
...
export function shouldSuppressContextMenuFollowUpClick(contextMenuOpenedAt: number, now: number): boolean {
  return (
...
export function findSidebarVirtualRowByKey(sidebar: Element, rowKey: string): HTMLElement | null {
  return (
