...
import type { findGithubWorkItemWorkspaceAttachment } from '@/lib/github-work-item-workspace-attachment'

export type TaskPageGitHubItemActionsProps = {
  item: GitHubWorkItem
  attachedWorkspace: ReturnType<typeof findGithubWorkItemWorkspaceAttachment>
  handleOpenOrUseGitHubWorkItem: (item: GitHubWorkItem) => void
  handleUseWorkItem: (item: GitHubWorkItem) => void
}

export function TaskPageGitHubItemActions({
  item,
  attachedWorkspace,
  handleOpenOrUseGitHubWorkItem,
  handleUseWorkItem
}: TaskPageGitHubItemActionsProps): React.JSX.Element {
  return (
