...
import { AppShellPageRenderer } from './app-shell-page-renderer'
import { useAppShellPageOnboardingEffects } from './app-shell-page-onboarding-effects'
import { useAppShellPageStartupEffects } from './app-shell-page-startup-effects'
import { useAppShellPageSessionEffects } from './app-shell-page-session-effects'
import { useAppShellPageShortcutEffects } from './app-shell-page-shortcut-effects'
...
function App(): React.JSX.Element {
  ...
  const { beginOnboardingSettingsDetour } = useAppShellPageOnboardingEffects({
    actions,
    activeModal,
  ...
  useAppShellPageShortcutEffects({
    actions,
    activeView,
    activeWorktreeId,
    creationLayoutActive,
    ...
    floatingTerminalOpen,
    floatingVisibleTabCount,
    globalShortcutStateRef,
    isFullScreen,
    keybindings,
    leftTitlebarChromeLayout,
    pluginCommands,
    setCollapsedSidebarHeaderWidth,
    setFloatingTerminalOpenWithFocus,
    settings,
    showSidebar,
    showSleepingWorkspaces,
    ...
    >
      <div className="flex h-full items-center">
        {isMacPlatform() && !isFullScreen ? (
          ...
          /* Why: Windows/Linux remove the native title bar, so render the logo plus a Â·Â·Â· button that pops the application menu (as Alt does). */
          <>
