...
if (hasSingleInstanceLock) {
  ...
  startupDeps.initSessionParseCachePersistence({
    filePath: startupDeps.join(startupDeps.getCanonicalUserDataPath(), 'ai-vault', 'session-parse-cache.json'),
    appVersion: startupDeps.app.getVersion()
  })
  ...
  startupDeps.initClaudeUsagePath()
  startupDeps.initCodexUsagePath()
  startupDeps.initOpenCodeUsagePath()
