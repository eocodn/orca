...
import { getShortBranchName, getEffectiveUpstreamStatusCacheKey, readOrProbeEffectiveUpstreamStatus, shouldProbeEffectiveUpstreamStatus, parseUnmergedEntry, detectConflictOperation } from './status-upstream'
