...
export async function yieldToClaudeUsageEventLoop(): Promise<void> {
...
export function stripClaudeSourceMetadata(turn: ClaudeUsageParsedSourceTurn): ClaudeUsageParsedTurn {
  return {
