...
import type { GitLabPagedResult } from '../../shared/gitlab-types'
...
import { listMergeRequests } from './gitlab-merge-requests'
 ...
 */
async function getWorkItemByProjectRef(
  repoPath: string,
...
export { parseHeaderInt, getWorkItemByProjectRef, mrStateToIssueState, listWorkItems, fetchIssuesAsWorkItems, listTodos }
