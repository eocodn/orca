...
import { broadcastPortForwards, enrichDetected, persistPortForwards } from './ssh-ipc-connections'

// Port forwarding handlers persist the manager's authoritative runtime state after each mutation.
