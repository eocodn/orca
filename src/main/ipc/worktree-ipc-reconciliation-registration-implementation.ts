// Worktree discovery, reconciliation, metadata, and lifecycle IPC registration implementation.
...
import { hydrateLineageWithinDeadline,
  listDesktopLineageForHost,
  listHostQualifiedDetectedWorktrees } from './worktree-ipc-events'
export { hydrateLineageWithinDeadline,
  listDesktopLineageForHost,
  listHostQualifiedDetectedWorktrees } from './worktree-ipc-events'
