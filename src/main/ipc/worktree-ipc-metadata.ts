...
export {
  buildDisconnectedDetectedWorktrees,buildFolderDetectedWorktrees,createFolderWorkspace,findExactRepoOwner,hasConflictingStoredWorktreeOwner,isCapturedRepoCurrent,
  listDetectedWorktreesForCapturedRepo,listVisibleFolderWorkspaces,resolveRepoOwnershipEvidence,type RepoOwnershipEvidence
} from './worktree-ipc-local'
