...
import { RuntimeBrowserInteractionExtras } from "./orca-runtime-browser-interaction-extras"
import type { BrowserCommandTargetParams } from "./orca-runtime-browser-base"

export class RuntimeBrowserExtraCommands extends RuntimeBrowserInteractionExtras {
  async browserCheck(
