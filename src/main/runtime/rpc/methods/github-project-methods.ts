...
import {
  SlugRepo, SlugAssignableUsers, ProjectRef, ProjectViews, ProjectViewTable, ProjectWorkItemDetailsBySlug,
  ProjectItemField, ClearProjectItemField, SlugIssueUpdate, SlugPullRequestUpdate, SlugIssueTypeUpdate,
  SlugIssueComment, SlugIssueCommentEdit, SlugIssueCommentDelete
} from "./github-schemas"
