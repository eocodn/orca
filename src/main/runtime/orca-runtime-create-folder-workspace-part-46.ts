import { normalizeFolderWorkspaceOperationId, isServerDriveListRequest, listWindowsDrives, gitExecFileAsync, randomUUID, isAbsolute, readdir, stat, type Repo, type NestedRepoScanResult, type FolderWorkspace, type ProjectGroupImportMode, type ProjectGroupImportResult, type DirEntry, type FilesystemPathFlavor, parseExecutionHostId, type ExecutionHostId, normalizeRuntimePathForComparison, type FolderWorkspacePathStatus, type FolderWorkspacePathStatusRequest, isGitRepo, getRepoName, DEFAULT_REPO_BADGE_COLOR, prepareLocalWorktreeRootForRepo, getSshFilesystemProvider, assertFolderWorkspacePathUsable, getFolderWorkspacePathStatus, getFolderWorkspacePathStatusForPath, detectRepoIconAndUpstream, scanNestedRepos, createNestedProjectGroupResolver, resolveNestedRepoSelection, createNestedRepoImportTargetResolver, runtimePathsEqual, normalizeSparsePresetDirectoriesForSave, normalizeSparsePresetName, sanitizeNestedRepoRuntimeImportError, runtimeRepoMatchesExecutionHost, resolveServerBrowsePath } from './orca-runtime-symbols'
