...
export const AgentBrowserBridgeMethods11 = {
  async storageSessionGet(this: any,
    key: string,
    worktreeId?: string,
  ...
  async storageSessionSet(this: any,
    key: string,
    value: string,
    worktreeId?: string,
    browserPageId?: string
  ...
  async storageSessionClear(this: any, worktreeId?: string, browserPageId?: string): Promise<unknown> {
    return this.enqueueTargetedCommand(worktreeId, browserPageId, async (sessionName) => {
      return await this.execAgentBrowser(sessionName, ['storage', 'session', 'clear'])
    })
  }
  async download(this: any,
    selector: string,
    path: string,
    worktreeId?: string,
    browserPageId?: string
