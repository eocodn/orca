...
import { BrowserManagerMethods1, type BrowserManagerMethods1Surface } from './browser-manager-lifecycle-set-dictation-shortcut-forwarding-predicate-install-certificate-request-guard'
import { BrowserManagerMethods2, type BrowserManagerMethods2Surface } from './browser-manager-lifecycle-remove-certificate-request-guard-resolve-browser-tab-id-for-guest-web-contents-id'
import { BrowserManagerMethods3, type BrowserManagerMethods3Surface } from './browser-manager-lifecycle-resolve-popup-owner-context-acquire-automation-visibility'
import { BrowserManagerMethods4, type BrowserManagerMethods4Surface } from './browser-manager-lifecycle-attach-guest-policies-cleanup-guest-policy-attachment'
import { BrowserManagerMethods5, type BrowserManagerMethods5Surface } from './browser-manager-lifecycle-register-guest-unregister-all'
import { BrowserManagerMethods6, type BrowserManagerMethods6Surface } from './browser-manager-lifecycle-get-guest-web-contents-id-get-session-profile-id-for-tab'
import { BrowserManagerMethods7, type BrowserManagerMethods7Surface } from './browser-manager-lifecycle-get-browser-page-load-error-build-load-error'
import { BrowserManagerMethods8, type BrowserManagerMethods8Surface } from './browser-manager-lifecycle-notify-certificate-failure-changed-handle-guest-will-download'
import { BrowserManagerMethods9, type BrowserManagerMethods9Surface } from './browser-manager-lifecycle-cancel-download-set-annotation-viewport-bridge'
import { BrowserManagerMethods10, type BrowserManagerMethods10Surface } from './browser-manager-lifecycle-do-set-annotation-viewport-bridge-impl-has-active-grab-op'
import { BrowserManagerMethods11, type BrowserManagerMethods11Surface } from './browser-manager-lifecycle-set-grab-mode-capture-selection-screenshot'
import { BrowserManagerMethods12, type BrowserManagerMethods12Surface } from './browser-manager-lifecycle-extract-hover-payload-setup-shortcut-forwarding'
import { BrowserManagerMethods13, type BrowserManagerMethods13Surface } from './browser-manager-lifecycle-setup-mouse-wheel-zoom-forwarding-flush-pending-permission-events'
import { BrowserManagerMethods14, type BrowserManagerMethods14Surface } from './browser-manager-lifecycle-send-permission-denied-send-popup-event'
import { BrowserManagerMethods15, type BrowserManagerMethods15Surface } from './browser-manager-lifecycle-bind-download-to-tab-send-download-started'
import { BrowserManagerMethods16, type BrowserManagerMethods16Surface } from './browser-manager-lifecycle-send-download-progress-finish-download-internal'
import { BrowserManagerMethods17, type BrowserManagerMethods17Surface } from './browser-manager-lifecycle-cancel-pending-downloads-for-guest-send-guest-load-failure'
import { BrowserManagerMethods18, type BrowserManagerMethods18Surface } from './browser-manager-lifecycle-open-link-in-orca-tab-open-link-in-orca-tab'
...
Object.assign(BrowserManager.prototype, BrowserManagerMethods1, BrowserManagerMethods2, BrowserManagerMethods3, BrowserManagerMethods4, BrowserManagerMethods5, BrowserManagerMethods6, BrowserManagerMethods7, BrowserManagerMethods8, BrowserManagerMethods9, BrowserManagerMethods10, BrowserManagerMethods11, BrowserManagerMethods12, BrowserManagerMethods13, BrowserManagerMethods14, BrowserManagerMethods15, BrowserManagerMethods16, BrowserManagerMethods17, BrowserManagerMethods18)
