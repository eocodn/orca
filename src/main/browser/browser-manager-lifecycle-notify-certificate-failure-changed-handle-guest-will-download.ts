...
export const BrowserManagerMethods8 = {
  notifyCertificateFailureChanged(this: any,
  ...
  notifyPermissionDenied(this: any, args: {
  ...
  handleGuestWillDownload(this: any, args: { guestWebContentsId: number; item: Electron.DownloadItem }): void {
