...
import type { LegacyPaneKeyAliasEntry, TerminalLayoutSnapshot, WorkspaceSessionState } from '../shared/types'
import type { MigrationUnsupportedPtyEntry } from '../shared/agent-status-types'
import { isTerminalLeafId, makePaneKey, parsePaneKey } from '../shared/stable-pane-id'
import { agentHookServer } from './agent-hooks/server'
import { cloneLayoutNode, cloneLayoutWithLeafIds, collectLayoutLeafCounts, collectLayoutLeafIdsInOrder, findWorktreeIdForTab, firstLayoutLeafId, leafRecordEquivalent, remapLeafRecordForPersistence } from './persistence-layout-records'
import { type LayoutLeafNormalization, type PaneIdentityMigrationEntries } from './persistence-state-automation'
