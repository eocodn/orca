import type { PersistedState, LegacyPaneKeyAliasEntry, TerminalLayoutSnapshot, WorkspaceSessionState } from '../shared/types'
import type { MigrationUnsupportedPtyEntry } from '../shared/agent-status-types'
import { type SshRemotePtyLease } from '../shared/ssh-types'
import { isTerminalLeafId, makePaneKey, parsePaneKey } from '../shared/stable-pane-id'
import { collectMigrationUnsupportedPtyEntries, legacyMigrationUnsupportedRowsToAliasEntries, normalizeTerminalLayoutSnapshotForPersistence } from './persistence-state-layout'
import { legacyPaneKeyAliasEntriesEqual, mergeLegacyPaneKeyAliasEntries, migrationUnsupportedEntriesEqual, normalizeLegacyPaneKeyAliasEntries } from './persistence-pane-identity-records'
