...
const { AMP_THREAD_ID_MAX_LENGTH, AMP_MAX_SCOPED_THREAD_CACHE_KEYS, readLastUserPromptFromTranscript, readBoundedString } = transcript
const { readAntigravityToolCall, isAntigravityFeedbackTool, isAntigravityStopStillBusy } = sourceTools
