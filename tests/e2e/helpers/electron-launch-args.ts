...
export function getOrcaElectronLaunchArgs(mainPath: string, headful: boolean): string[] {
  ...
  // mode 4755 in node_modules). The packaged launcher injects --no-sandbox;
  // raw spawn() paths (e.g. second-instance activation) must match or
  // Chromium aborts with SIGTRAP before handshake.
