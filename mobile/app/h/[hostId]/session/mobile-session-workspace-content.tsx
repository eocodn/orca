...
import { getTerminalCommandKeyboardType, getTerminalLiveInputKeyboardType } from '../../../../src/terminal/terminal-keyboard-type'
...
export function renderMobileSessionContent(context: WorkspaceContext) {
  const { client, worktreeId, activePanel, sessionContentRowWidth, canDockPanel, setActivePanel,
    ...
    diffComments, diffCommentBusy, activeBrowserTab, browserScreencastSupported, insets, showToast,
    activePendingTerminalTab, terminals, terminalFrameHeightRef, setTerminalFrameWidth, notifyTerminalFrameHeight,
    activeHandle, activeTerminalKeyboardLift, terminalTextScale, setTerminalTextScale, saveTerminalTextScale,
