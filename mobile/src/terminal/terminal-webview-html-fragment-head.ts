...
export const terminal_webview_html_fragment_head = `
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<style>${terminalWebviewTemplateValues.XTERM_ENGINE_CSS}</style>
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  html, body {
    background: ${terminalWebviewTemplateValues.colors.terminalBg};
    overflow: hidden;
    width: 100%;
    height: 100%;
  }
  ...
  #scroll-thumb {
    ...
    min-height: 24px;
    border-radius: 999px;
    background: ${terminalWebviewTemplateValues.colors.textSecondary};
...
<script>${terminalWebviewTemplateValues.XTERM_ENGINE_JS}</script>
<script>
(function() {
  ...
  var term = null; ${terminalWebviewTemplateValues.TERMINAL_QUERY_REPLY_JS}
  ${terminalWebviewTemplateValues.TERMINAL_SURFACE_SWAP_JS}
  ...
  var TEXT_SCALE_PRESETS = ${JSON.stringify([...terminalWebviewTemplateValues.TERMINAL_TEXT_SCALES])};
